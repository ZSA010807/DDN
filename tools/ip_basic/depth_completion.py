...
def main():
    ...
    ##############################
    # Validation set
    input_depth_dir = '/opt/data/private/work/code/CaDDN/data/nuscenes/v1.0-trainval/depth_2/depth_map_raw_train'
    ...
    output_depth_dir = '/opt/data/private/work/code/CaDDN/data/nuscenes/v1.0-trainval/depth_2/depth_map_dense_train'
